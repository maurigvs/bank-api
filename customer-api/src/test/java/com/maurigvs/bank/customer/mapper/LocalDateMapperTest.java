...
import com.maurigvs.bank.customer.exception.DateFormatException;
...
class LocalDateMapperTest {
    ...
    void should_throw_DateFormatException_given_an_String_with_wrong_format() {
        ...
        var exception = assertThrows(DateFormatException.class, () -> new LocalDateMapper().apply(localDate));
